...
const UserPage = () => {
  const {getUser, user, loading, repos} = useContext(GitContext)
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                ...
                {hireable && (
                  <div className="mx-1 badge bage-info">
                    Hirable
                  </div>
                )}
              </h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
              {location && (
                <div className="stat">
